...
//      value.asInstanceOf[org.zachary.aws_repl.ExtendedS3Client].listBuckets()
//    }
...
//        System.out.println(s"bound: $value")
  ...
  object parse {
    ...
    def withIncompleteHandler[T](handler: (Position, String) => Unit)(thunk: =>
    T) = {
